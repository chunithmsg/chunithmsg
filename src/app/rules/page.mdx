...
<div className="grid grid-cols-3 justify-items-center my-7">
...
If there are any other questions that are not covered in this document, feel free to contact any of the Organisers by joining the [Chunithm SG Discord](url). Please provide the relevant proof needed before being granted entry into the Discord.
